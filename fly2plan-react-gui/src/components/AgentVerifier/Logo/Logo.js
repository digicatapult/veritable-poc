/**
 * This function renders the logo of the verifier page.
		...
		<>
			<div className="float-left ml-1 mr-0" style={{width: 35}}>
				<svg viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path fill="#F7FA7B" d="M16.63,105.75c0.01-4.03,2.3-7.97,6.03-12.38L1.09,79.73c-1.36-0.59-1.33-1.42-0.54-2.4l4.57-3.9
