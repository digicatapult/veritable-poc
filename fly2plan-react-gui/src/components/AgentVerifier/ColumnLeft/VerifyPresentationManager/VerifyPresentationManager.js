...
export default function VerifyPresentationManager(
	{
		statusRecords, selectedExchange, onChangeExchange,
		dataPresExIds, selectedVersion, onVerifySubmit,
		statusVerify
	}
) {
			...
			<div className="row">
				<div className="col-md-12">
					...
					<div className="form-group">
						...
						<select name="structure" className="form-control"
							id="exchange" value={selectedExchange}
