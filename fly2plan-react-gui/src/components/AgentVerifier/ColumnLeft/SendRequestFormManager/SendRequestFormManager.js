...
export default function SendRequestFormManager(
	{
		onChosenValidity, selectedValidity, onActivatedTodaySwitch,
		onToggleValidityLock, isLockedForm, isValidityLocked,
		onInputId, selectedId, onInputName,
		selectedName, onInputSurname, selectedSurname,
		selectedType, onChangeType, selectedVersion,
		submitProofReqHandler, statusConnId, statusSendReq,
		isDisconnected
	}
) {
		...
		<form>
					...
					<div className="form-group">
						...
						<div className="input-group">
							...
							<input type="date" className="form-control"
								id="validity" value={selectedValidity}
							...
							<div className="input-group-append" id="valid-lock">
								...
								>
									<small>
										<i className={`fa fa-${isValidityLocked?'lock':'unlock-alt'}`} />
									</small>
								</button>
							</div>
						</div>
				...
				<div className="col-md-3">
					...
					<div className="form-group">
						...
						<button className="btn btn-primary w-100" type="button"
							id="today" onClick={onActivatedTodaySwitch}
							disabled={isLockedForm}
						>
							<small><i className="fa fa-calendar" aria-hidden="true" /> Today</small>
						</button>
					</div>
			...
			<div className="row">
				<div className="col-md-12">
					...
					<div className="form-group">
						<div className="input-group">
							<div className="input-group-text"><small>Flyer Id: &nbsp;</small></div>
							<input type="text" className="form-control"
								id="fid" placeholder="GBR-RP-1"
								onChange={onInputId}
								disabled={isLockedForm}
								value={selectedId}
							/>
			...
			<div className="row">
				<div className="col-md-12">
					...
					<div className="form-group">
						<div className="input-group">
							<div className="input-group-text"><small>Name:&nbsp; &nbsp; &nbsp;</small></div>
							<input type="text" className="form-control"
								id="name" placeholder="Alice"
			...
			<div className="row">
				<div className="col-md-12">
					...
					<div className="form-group">
						<div className="input-group">
							<div className="input-group-text"><small>Surname:</small></div>
							<input type="text" className="form-control"
								id="surname" placeholder="Smith"
			...
			<div className="row">
				...
				<div className="col-md-6">
					...
					<button type="button" className="btn btn-primary w-100"
						disabled={selectedVersion===''||isDisabledForm()||isLockedForm}
