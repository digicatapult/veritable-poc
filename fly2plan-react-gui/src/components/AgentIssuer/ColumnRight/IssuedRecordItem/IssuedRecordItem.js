					...
					<div className="table-responsive">
						<table className="table table-striped">
							<tbody>
								...
								<tr>
									<td><b>timestamp:</b></td>
									<td>{new Date(record.cred_ex_record.cred_preview.attributes[7].value * 1000).toISOString()}</td>
								</tr>
								<tr>
									<td><b>id:</b></td>
									<td>{record.cred_ex_record.cred_preview.attributes[0].value}</td>
								</tr>
								<tr>
									<td><b>name:</b></td>
									<td>{record.cred_ex_record.cred_preview.attributes[1].value}</td>
								</tr>
								<tr>
									<td><b>surname:</b></td>
									<td>{record.cred_ex_record.cred_preview.attributes[2].value}</td>
								</tr>
								<tr>
									<td><b>type:</b></td>
									<td>{record.cred_ex_record.cred_preview.attributes[3].value}</td>
								</tr>
								<tr>
									<td><b>title:</b></td>
									<td>{record.cred_ex_record.cred_preview.attributes[4].value}</td>
								</tr>
								<tr>
									<td><b>subtitle:</b></td>
									<td>{record.cred_ex_record.cred_preview.attributes[5].value}</td>
								</tr>
								<tr>
									<td><b>schema:</b></td>
									<td>{record.cred_ex_record.by_format?.cred_issue?.indy?.schema_id}</td>
								</tr>
								<tr>
									<td><b>expiration_date:</b></td>
									<td>{record.cred_ex_record.cred_preview.attributes[6].value}</td>
								</tr>
							</tbody>
						</table>
					</div>
