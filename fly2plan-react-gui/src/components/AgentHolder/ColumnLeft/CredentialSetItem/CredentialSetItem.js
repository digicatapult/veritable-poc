...
export default function CredentialSetItem(
	{
		item: {
			cred_def_id,
			attrs: {timestamp, id, name, surname, type, title, subtitle, expiration_dateint: d}
		},
		index
	}
) {
		...
		*/
		<>
			...
			<ul className="list-group list-group-flush">
				...
				<li className="list-group-item">
					<div className="row small text-dark">
						<div className="col-md-6 text-uppercase text-muted">Certificate Title:</div>
						<div className="col-md-6">{title}</div>
					</div>
				</li>
				<li className="list-group-item">
					<div className="row small text-dark">
						<div className="col-md-6 text-uppercase text-muted">Certificate Subtitle:</div>
						<div className="col-md-6">{subtitle}</div>
					</div>
				</li>
				<li className="list-group-item">
					<div className="row small text-dark">
						<div className="col-md-6 text-uppercase text-muted">Expires On:</div>
						<div
