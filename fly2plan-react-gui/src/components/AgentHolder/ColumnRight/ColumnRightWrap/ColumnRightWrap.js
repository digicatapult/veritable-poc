...
export default function ColumnRightWrap({origin}) {
	...
	*/
	...
	const [ statusRecordEvents, errorRecordEvents, startGetRecordsHandler ] = useGetLoopedPresentProofRecords()
	...
	useEffect(()=>{
		...
		return function clear() { return clearInterval(intervalRecordsFetch) }
	...
	return (
		<>
				...
				<div className="container py-1">
					<div className="row">
						<div className="col-md-12">
							...
							<ExchangeRecordsTable dataConnRecordEvents={dataConnRecordEvents} />
			...
			<div className={errorRecordEvents?'d-block':'d-none'} style={{position: 'fixed', width: '10%', height: '10%', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', zIndex: 100}}>
				<div className="text-light m-2 p-2"> <small>{errorRecordEvents}</small> </div>
			</div>
