...
export default function usePostConnReceiveInvitation() {
	...
	const onStartReceiveInv=useCallback((origin, body, persona, setStatusVal, setStoreData)=>{
		const bodyB64 = body
		...
		post(origin, path, params, body, setStatusVal, setError, setStoreData, transformData)
	}, [])
